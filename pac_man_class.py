...
#--------------------------HELPER FUNCTIONS-------------------------------#
    ...
    def load(self):
        self.background = pygame.image.load("groundpacman.png")
        self.background = pygame.transform.scale(self.background, (MAZE_WIDTH,MAZE_HEIGHT))


        #opening walls file
        #creaing walls list with co-ords of walls
    ...
    def draw_grid(self):
       ...
       #    pygame.draw.rect(self.background,(0,255,0), (coin.x*self.cell_width, 
...
#------------------------------------------------------------# Intro Functions
    ...
    def start_draw(self): 
        ...
        self.draw_text("PUSH SPACE BAR",self.screen,[WIDTH//2,HEIGHT//2]
                       ,START_TEXT_SIZE, (255,255,0), START_FONT, centered=True)
        self.draw_text("1 PLAYER ONLY",self.screen,[WIDTH//2,HEIGHT//2+50]
                       ,START_TEXT_SIZE, (143,202,221), START_FONT, centered=True)
        self.draw_text("Marcelo's Pacman",self.screen,[WIDTH//2,HEIGHT//2+100]
                       ,START_TEXT_SIZE, (191,255,0), START_FONT, centered=True)
...
#-----------------------Playing Functions-------------------------------------# 
    ...
    def playing_draw(self): 
        ...
        self.draw_text("CURRENT SCORE: {}".format(self.player.current_score), self.screen,[60,0],18, WHITE ,
         START_FONT, centered = False)
        self.draw_text("HIGH SCORE: 0", self.screen,[WIDTH//2+60,0],18, WHITE ,
         START_FONT, centered = False)
        self.player.draw()
...
################################### GAME OVER ##################################
    ...
    def game_over_draw(self):    
        ...
        self.screen.fill(BLACK)
        quit_text = "Press the scape button to QUIT"
